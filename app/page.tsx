...
VERSION:3.0
N:Kazombaruru;Lorein;;;  
FN:Lorein Kazombaruru
TITLE:Wealth Administration
ORG:IJG namibia
EMAIL;type=WORK: lorein@ijg.net
TEL;type=CELL: +264819583521
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl">
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Lorein Kazombaruru </h1>
                <p className="text-lg font-medium text-[#094794]">Wealth Administration</p>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <a href="mailto:lorein@ijg.net" className="text-sm text-gray-700 hover:text-[#094794]">
                    lorein@ijg.net
                  </a>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+264819583521" className="text-sm text-gray-700 hover:text-[#094794]">
                    +264819583521
                  </a>
                </div>
              </div>
